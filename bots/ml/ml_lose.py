...
def features(state):
    ...
    # Add ratio of cards of player 1
    # ratio1 = util.ratio_points(state, 1)

    # # Add the hand of the current player
    # hand = state.hand()
    # card_value = 0 
    # for i, card in enumerate(hand):
    #     if trump_suit == card[1]
    ...
    # moves = state.moves()    
    # # Add remaining trump cards in hand if phase 
    # moves_trump_suit = []
    ...
    # Append ratio of points for p1 to feature set 
    # feature_set.append(ratio1)
    
    # Append ratio of points for p2 to feature set 
    # feature_set.append(ratio2)
    
    # Append the amount of trump cards in hand to feature set 
    # feature_set.append(len(moves_trump_suit) if phase == 1 else len(moves_trump_suit) * 5)
